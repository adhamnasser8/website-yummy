let navbarInnerwidth = $(".navbar-inner").innerWidth();
function opennavbar() {
...
function closenavbar() {
  $("#navbar").animate({ left: -navbarInnerwidth }, 500);
  $(".open-close-icon").addClass("fa-align-justify");
  $(".open-close-icon").removeClass("fa-x");
  $(".navbar-links li").animate({ top: 300 }, 500);
}
$(document).ready(function () {
  ...
  $("#navbar").css("left", -navbarInnerwidth);
  $(" #navbar .open-close-icon").click(function () {
...
$("#navbar .ingredients").click(function () {
  closenavbar();
  getIngredients();
});
